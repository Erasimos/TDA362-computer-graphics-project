...
void display()
{
	...
	///////////////////////////////////////////////////////////////////////////
	FboInfo &securityFB2 = fboList[1];
	glBindFramebuffer(GL_FRAMEBUFFER, securityFB2.framebufferId);
	...
	glBindTexture(GL_TEXTURE_2D, securityFB2.colorTextureTarget);
	labhelper::drawFullScreenQuad();
